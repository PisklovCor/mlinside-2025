...
class TimePeriodTest {
    ...
    void testApiValues() {
        assertEquals("1", TimePeriod.ONE_DAY.getApiValue());
        assertEquals("7", TimePeriod.ONE_WEEK.getApiValue());
        assertEquals("30", TimePeriod.ONE_MONTH.getApiValue());
        assertEquals("90", TimePeriod.THREE_MONTHS.getApiValue());
        assertEquals("180", TimePeriod.SIX_MONTHS.getApiValue());
        assertEquals("365", TimePeriod.ONE_YEAR.getApiValue());
    ...
    void testDisplayNames() {
        assertEquals("1 Day", TimePeriod.ONE_DAY.getDisplayName());
    ...
    void testDays() {
        assertEquals(1, TimePeriod.ONE_DAY.getDays());
    ...
    void testFromApiValue() {
        assertEquals(TimePeriod.ONE_DAY, TimePeriod.fromApiValue("1"));
    ...
    void testValueOf() {
        assertEquals(TimePeriod.ONE_DAY, TimePeriod.valueOf("ONE_DAY"));
        assertEquals(TimePeriod.ONE_WEEK, TimePeriod.valueOf("ONE_WEEK"));
